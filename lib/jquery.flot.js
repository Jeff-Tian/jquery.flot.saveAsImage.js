...
(function ($) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(styleCache, angleKey)) {
                                ...
                                for (var key in angleCache) {
                                    if (Object.prototype.hasOwnProperty.call(angleCache, key)) {
                                        ...
                                        for (i = 0; !!positions && (position = positions[i]); i++) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function drawGrid() {
            ...
            // draw markings
            // I moved the "draw markings" block to behind the "draw ticks" block. Because if 
            // you draw markings first, and then draw ticks, the markings are always look like 
            // to be behind the ticks layer, but sometimes we may want the markings to be above 
            // the ticks layer.
            // On the opposite, if you draw ticks first, and then you draw the markings, the 
            // markings will look like to be above the ticks layer. When you want the markings
            // to be behind it, you can give the markings a color with the opacity value less than
            // 1, for example, color: "rgba(56, 100, 155, 0.8)". So it is more flexible.
